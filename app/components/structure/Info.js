...
export default function Info() {
  return (
    <div className={styles.info}>
      <h1>Dm taller</h1>
      <p>
        ¡Bienvenido a DM Taller, tu destino para muebles de calidad y diseño
        único! En DM Taller, nos apasiona crear piezas de mobiliario
        excepcionales que complementen tu estilo de vida y realcen la belleza de
        tu hogar. Nuestro equipo de artesanos y diseñadores altamente
        capacitados trabajan con dedicación y atención al detalle para ofrecerte
        muebles de la más alta calidad. Ya sea que estés buscando ese sofá
        perfecto para relajarte después de un largo día, una mesa de comedor que
        se convierta en el centro de atención en tus cenas familiares o una
        cómoda que combine funcionalidad y elegancia en tu dormitorio, en DM
        Taller encontrarás una amplia selección de muebles para cada espacio de
        ...
        que desees elegir la tapicería, los acabados o los detalles decorativos,
